...
def parse_opts():
    ...
    parser.add_argument('--certification_method', default='randomized_ablation', type=str) 
    parser.add_argument('--k', default='3000', type=int) 
    parser.add_argument('--k1', default='5', type=int) 
    parser.add_argument('--k2', default='1000', type=int) 
    ...
    parser.add_argument('--lr_steps', default=[30, 40, 65, 70, 200, 250], type=float, nargs="+", metavar='LRSteps', help='epochs to decay learning rate by 10')
